...
public class SAPCXRulesDefinition implements RulesDefinition
{

    // don't change that because the path is hard coded in CheckVerifier
    private static final String RESOURCE_BASE_PATH = "org/sonar/l10n/java/rules/java";

    public static final String REPOSITORY_KEY = "ibmix-sapcx-java";

    public static final String REPOSITORY_NAME = "IBM iX - SAP Commerce";
    ...
    public SAPCXRulesDefinition(SonarRuntime runtime)
    {
